...
@NgModule({
  declarations: [AppComponent, DisplayDataComponent, TemplateSyntaxComponent, WidthChangeComponent, DoubleNumberPipe, ComponentInteractionComponent, InputChildComponent, EventChildComponent, DisplayResultPipe, TimerChildComponent, CountChildComponent],
